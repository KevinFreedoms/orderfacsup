...
<html>
  ...
  <body>
                	...
                	<tr>
						<td id="col1" class="col1">
							<ul id="pageButtons">
                                ...
                                <li class="selected"><a class="delivery" href="<%=basePath%>facorder/manager/toPcDelivery.do">直送<i class="menu-triangle" style="display:inline-block"></i></a></li>
                                <!-- jiaself -->
                                    ...
                                    <ul id="fields" class="fields">
                                    	<li class="date" type="date" reqd="1">
                                            <div class="content oneline">
                                            	<label class="desc">配送日期</label>
                                                <input type="text" readonly data-role="datebox" id="deliverydate" style="width:160px;"onChange="initDeliveryOrder()">
                                        	</div>
                                    	</li>
                                	...
                                	<table class="table" cellspacing="0" id="kingTable" style="display: none;">
                                    	<thead>
                                            <tr >
                                                ...
                                                <th style="width: 10%;">类别数</th>
                                                <th style="width: 10%;">应收数量</th>
                                                <th style="width: 10%;">实收数量</th>
                                ...
                                <form class="form">
                                    <div class="info" id="formHeader">
                                    	<div style="text-align:left;float:left">
                                    		...
                                    		<input id="btnSubmit" type="button" class="commonbtn" value="导出Excel" onClick="deliveryExportExcel()">
                                    	</div>
                                    	...
                                    	<h4 style="text-align:center;font-family:微软雅黑">直送明细</h4>
    ...
    <script>
	    ...
	    document.write("<s"+"cript type='text/javascript' src='<%=basePath%>js/page/delivery/delivery.js?"+Math.random()+"'></scr"+"ipt>");
	</script>
    <!-- jiaself  -->
