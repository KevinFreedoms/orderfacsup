  ...
  <body>
    <div data-role="page" id="loginpage">         
		<div data-role="content" role="main" style="max-width:600px;margin:auto;">      
        	<div data-role="fieldcontain" style="text-align:center;">
            	<img src="<%=basePath%>images/fy.png"/>
            </div>
        
        	<div data-role="fieldcontain">
            	<p>用户账号</p>
            	<input id="user" type="text" placeholder="请输入您的用户账号或手机号" />
                <p>密&nbsp;&nbsp;&nbsp;码</p>
    ...
    <div data-role="page" id="passwordpage">       
    	<div data-role="header" style="max-width:600px;margin:auto;">
           <a data-role="none" data-icon="back" title="返回登录界面" rel="external" href="#loginpage">
        ...
        <div data-role="content" role="main" style="max-width:600px;margin:auto;">      
        	<div data-role="fieldcontain">
                    <p>用户账号</p>
                    <input id="username" name="model.yhbm" type="text" placeholder="请输入您的用户账号或手机号" />
                    <p>原密码</p>
